  ...
  return (
    <section className="w-full py-20">
      ...
      <div className="lg:my-20 mt-7 mb-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        ...
        <Card 
            title="Developement & Progress Update" 
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20">
        <div className="text-center group-hover/canvas-card:-translate-y-4 absolute top-[40%] left-[50%] translate-x-[-50%] group-hover/canvas-card:opacity-0 transition duration-200 w-full  mx-auto flex items-center justify-center">
          {icon}
        </div>
